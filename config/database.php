    ...
    */
    ...
    'connections' => [
        ...
        'channel_mysql' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('CHANNEL_DB_HOST', '127.0.0.1'),
            'port' => env('CHANNEL_DB_PORT', '3306'),
            'database' => env('CHANNEL_DB_DATABASE', 'hg'),
            'username' => env('CHANNEL_DB_USERNAME', 'root'),
            'password' => env('CHANNEL_DB_PASSWORD', 'root'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => env('DB_PREFIX',''),
