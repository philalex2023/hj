...
trait SmsTrait
{
    ...
    {
        $smsKey = 'sms_codes_'.$phone;
        $redis = $this->redis();
        $hashValue = $redis->hGetAll($smsKey);
        if($hashValue['code']==$code && strtotime("-30 minute")<$hashValue['at_time']){
            return $hashValue;
        }
        return false;
    ...
    public function sendChinaSmsCode($phone, $code)
    {
        ...
        if($getBody['error_code'] > 0){
            ...
            Log::debug('==send_China_smsSuccess_code==',$getBody);
        }
        /*
         * 成功返回以下结果
         * {
    ...
    public function sendInternationalSmsCode($areaNum, $phone, $code)
    {
        ...
        if($getBody['error_code'] > 0){
            ...
            Log::debug('==send_International_smsSuccess_code==',$getBody);
        }
        /*
         * 成功返回以下结果
         * {
