            ...
            do {
                ...
                foreach ($blockCat as &$item){
                    ...
                    if(!empty($ids)){
                        ...
                        $videoList = $videoBuild->limit($limit)->get(['video.id','video.is_top','name','gold','cat','tag_kv','sync','title','hls_url','duration','type','restricted','cover_img','views','likes','updated_at'])->toArray();
